...
const Sidebar = () => {
  ...
  return (
    <aside className="sticky top-10 flex flex-col h-full w-[320px] bg-background text-foreground rounded-2xl shadow-lg p-4 gap-4 min-h-[90vh] max-h-[98vh] border overflow-hidden">
      {/* Navigation */}
      <nav className="flex flex-col gap-1 bg-muted/60 rounded-xl p-2 overflow-auto max-h-[50vh]">
      ...
      {/* User Info */}
      <Card className="mb-2 bg-muted/70 border-none shadow-none max-w-full overflow-hidden">
